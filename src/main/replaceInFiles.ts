...
// can be taken back without a full local-history feature. Held in memory only:
// an undo that survives a restart would need the retention policy that comes
// with local history (docs/FEATURE_IDEAS.md §2).
