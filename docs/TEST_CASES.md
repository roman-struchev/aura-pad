...
| A19 | Ports | A node process started by the case shows up in the list with its pid, the tab filters down to that port, stopping it asks first and then really stops it, the row goes, and a pid that is no longer listening (or pid 1) is refused |
